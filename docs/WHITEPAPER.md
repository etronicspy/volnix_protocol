...
**Version 4.19:** Genesis: two bootstrap wallets (Supplier + Validator, no ZKP), no Supervisor role; same MOA as for ZKP roles; genesis ANT = EpochBlocks × L_total
