...
// BIP39 wordlist для валидации (первые 2048 слов из стандартного списка)
const BIP39_WORDS = [
  ...
  'expel', 'expense', 'expensive', 'expert', 'explain', 'expose', 'express', 'extend',
  ...
  'lottery', 'loud', 'lounge', 'love', 'low', 'loyal', 'lucky', 'luggage',
  ...
  'nominee', 'none', 'noodle', 'normal', 'north', 'nose', 'notable', 'note',
  ...
  'receive', 'recipe', 'record', 'recycle', 'red', 'reduce', 'reflect', 'reform',
  ...
  'ride', 'ridge', 'rifle', 'right', 'rigid', 'ring', 'riot', 'rip',
  'ripe', 'rise', 'risk', 'ritual', 'rival', 'river', 'road', 'roast',
