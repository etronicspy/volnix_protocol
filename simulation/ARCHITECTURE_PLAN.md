...
- [x] **§6.3 genesis**: один seed-кошелёк (1 LZN + 1 ANT) + ZKP/роли 5 валидаторов и 5 поставщиков в genesis-блоке + sim_treasury.
...
|---|---|---|
| Коридор Σb_i | `(1−λ)·L_total ≥ Σb_i ≥ λ·L_total`, `λ ≤ 5/12`; эталон λ=1/3 → `[⅓,⅔]·L`; при `b_i=0` нет WRT/комиссий | ✅ |
